class Admin::ProjectTagsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @project_tag.save
        format.html { redirect_to [:admin, @project_tag], notice: 'Project tag was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @project_tag.update(project_tag_params)
        format.html { redirect_to [:admin, @project_tag], notice: 'Project tag was successfully updated.' }
  ...
  def destroy
    @project_tag.destroy
    respond_to do |format|
      format.html { redirect_to admin_project_tags_url, notice: 'Project tag was successfully destroyed.' }
  ...
  private
    ...
    def project_tag_params
      params.require(:project_tag).permit(:title_vn, :content_vn, :title_en, :content_en)
    end
end
