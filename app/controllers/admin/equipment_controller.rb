class Admin::EquipmentController < ApplicationController
  ...
  private
    ...
    def equipment_params
      params.require(:equipment).permit(:image_url, :name_vn, :quantity, :category_equipment_id, :manufacturer_equipment_id, :status_vn, :capacity, :note_vn, :name_en, :status_en, :note_en)
    end
end
