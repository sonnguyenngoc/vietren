class Admin::CustomerContactsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @customer_contact.save
        format.html { redirect_to [:admin,@customer_contact], notice: 'Customer contact was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @customer_contact.update(customer_contact_params)
        format.html { redirect_to [:admin, @customer_contact], notice: 'Customer contact was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_customer_contacts_url, notice: 'Customer contact was successfully destroyed.' }
