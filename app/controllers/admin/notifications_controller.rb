class Admin::NotificationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @notification.save
        format.html { redirect_to [:admin, @notification], notice: 'Notification was successfully created.' }
  ...
  private
    ...
    def notification_params
      params.require(:notification).permit(:title_vn, :content_vn, :title_en, :content_en)
    end
end
