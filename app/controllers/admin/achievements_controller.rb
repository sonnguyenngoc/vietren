class Admin::AchievementsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @achievement.save
        format.html { redirect_to [:admin, @achievement], notice: 'Achievement was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @achievement.update(achievement_params)
        format.html { redirect_to [:admin, @achievement], notice: 'Achievement was successfully updated.' }
  ...
  private
    ...
    def achievement_params
      params.require(:achievement).permit(:tag_vn, :title_vn, :content_vn, :tag_en, :title_en, :content_en)
    end
end
