class Admin::CareersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @career.save
        format.html { redirect_to [:admin, @career], notice: 'Career was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @career.update(career_params)
        format.html { redirect_to [:admin,@career], notice: 'Career was successfully updated.' }
  ...
  def destroy
    @career.destroy
    respond_to do |format|
      format.html { redirect_to admin_careers_url, notice: 'Career was successfully destroyed.' }
  ...
  private
    ...
    def career_params
      params.require(:career).permit(:title_vn, :content_vn, :title_en, :content_en)
    end
end
